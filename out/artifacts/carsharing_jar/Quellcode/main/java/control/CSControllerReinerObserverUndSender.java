...
public class CSControllerReinerObserverUndSender implements IGUIEventListener, IUpdateEventSender {
	...
	public CSControllerReinerObserverUndSender(String csvFilePath) {
	...
	private void writeCSVData() throws IOException {
		...
		csvWriter = new CSVWriter(Objects.requireNonNull(path + "/CSVFiles/Buchungen.csv"), false);
	...
	private void loadCSVData() throws IOException {
		...
		for(int key: paths.keySet()){
			...
			//InputStream filePath = this.getClass().getResourceAsStream(path);  // ohne "file:" am Anfang
